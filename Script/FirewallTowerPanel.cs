...
public partial class FirewallTowerPanel : Panel
{
    ...
    private const int TOWER_PRICE = 25;
    ...
    private void _on_gui_input(InputEvent @event)
    {
            ...
            MB1.Pressed && !dragging)
        {
            ...
            {
                GD.Print("Not enough coins to buy the tower!");
                return;
            }
    ...
    private void StartDragTower()
    {
        ...
        GameManager.Instance.IsPlacingTower = true;
    ...
    private bool TowerPlacement()
    {
        ...
        {
            GD.Print("Another tower already exists on this base!");
            return false;
        }
        ...
        GameManager.Instance.IsPlacingTower = false;
